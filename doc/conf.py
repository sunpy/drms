...
project = 'drms'
copyright = '2016, Kolja Glogowski'
...
# Default highlight language, needed for copybutton.js
...
latex_documents = [
    (master_doc, 'drms.tex', 'drms Documentation',
     'Kolja Glogowski', 'manual'),
]
...
man_pages = [
    (master_doc, 'drms', 'drms Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'drms', 'drms Documentation',
     author, 'drms', 'One line description of project.',
     'Miscellaneous'),
]
